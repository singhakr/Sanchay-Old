...
import sanchay.mlearning.weka.ArffExtractFeatures;
import sanchay.mlearning.weka.DefaultArffData;
...
//            SSFStory ssfStory = ssfCorpus.getStory(storyPath);
        ...
        System.arraycopy(arffExtractFeatures.getAttributeNames(), 0, keys, 0, keys.length - 1);
