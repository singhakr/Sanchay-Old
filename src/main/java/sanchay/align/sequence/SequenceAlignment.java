...
public abstract class SequenceAlignment extends DynamicProgramming {
   ...
   protected Object getTraceback() {
      ...
      SequenceCell currentCell = getTracebackStartingCell();
   ...
   protected abstract boolean traceBackIsNotDone(SequenceCell currentCell);
   ...
   protected abstract SequenceCell getTracebackStartingCell();
}
