...
public class TextDiff
{
    ...
    public Report compare(String oldFileName, String newFileName, String charset) throws Exception
    {
        return compare( new File( oldFileName ), new File( newFileName ), charset );
    }

    /** Compare two Files */
    public Report compare(File oldFile, File newFile, String charset) throws Exception
    {
        String[] lOld = new TextFileIn( oldFile, charset ).asArray();
        String[] lNew = new TextFileIn( newFile, charset ).asArray();
