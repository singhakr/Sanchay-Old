 ...
 * @author anil
 */
public class TreeViewNodeEditPopupListener extends MouseAdapter
{
     ...
     protected SanchayTreeViewerJPanel sanchayTreeViewerJPanel;
     protected List namedNodes;
     protected List attribNames;

     protected Point point;

     public TreeViewNodeEditPopupListener(SanchayJTable sanchayJTable, JPopupMenu pm, Hashtable nodeLabelEditors, SanchayTableModel fsSchema) {
        popup = pm;
    ...
    public TreeViewNodeEditPopupListener(JPopupMenu pm, SanchayTableModel fsSchema) {
        popup = pm;
...
//        featureDeleteJMenu = new JMenu("Delete Attribute");
    ...
    public void setSanchayTreeJPanel(SanchayTreeViewerJPanel sanchayTreeViewerJPanel)
    {
        this.sanchayTreeViewerJPanel = sanchayTreeViewerJPanel;
    }
