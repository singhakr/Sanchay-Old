 ...
 * @author  RAKESH
 */
public class DiscourseAnnotationJPanel extends javax.swing.JPanel
        implements SanchayClient , sanchay.gui.common.JPanelDialog {

    protected ClientType clientType = ClientType.DISCOURSE_ANNOTATION;
   ...
   public DiscourseArgOptionalJPanel discourseArgOptionalJPanel;
    
    
    /** Creates new form DiscourseConnectiveTreeJPanel */
    public DiscourseAnnotationJPanel(String lancEnc) {
...
//        textEditorJPanel = new TextEditorJPanel(lancEnc);
        ...
        discourseArgOptionalJPanel = new DiscourseArgOptionalJPanel(lancEnc, textEditorJPanel, this);        
...
//        discourseArgOptionalJPanel.setTextEditorJPanel(textEditorJPanel);
    ...
    public DiscourseArgOptionalJPanel getConnectiveInfoJPanel() {
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame(GlobalProperties.getIntlString("Discourse_Annotation_Interface"));
...
//        System.out.println("Input method selected: " + imc.selectInputMethod(new Locale("hi", "in", "Inscript")));
	...
	DiscourseAnnotationJPanel newContentPane = null;

	if(selectedLanguage == null || selectedLanguage .equals("") == true)
	    newContentPane = new DiscourseAnnotationJPanel(GlobalProperties.getIntlString("hin::utf8"));
	else
	{
	    newContentPane = new DiscourseAnnotationJPanel(SanchayLanguages.getLangEncCode(selectedLanguage));
	}
