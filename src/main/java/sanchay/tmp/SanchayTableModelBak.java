 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SanchayTableModelBak extends DefaultTableModel implements Resource, SanchayDOMElement {
    ...
    protected SanchayTableModelBak schema;
    ...
    public SanchayTableModelBak(DBConnection c, String tableName) {
        super();
    ...
    public SanchayTableModelBak(String url, String tableName, String driverName, String user, String passwd)
    {
        super();
    ...
    public SanchayTableModelBak(int rowCount, int columnCount) {
    ...
    public SanchayTableModelBak(Object[][] data, Object[] columnNames) {
    ...
    public SanchayTableModelBak(Object[] columnNames, int rowCount) {
    ...
    public SanchayTableModelBak(Vector columnNames, int rowCount) {
        super(columnNames, rowCount);
    ...
    public SanchayTableModelBak(ArrayList<String> columnNames, int rowCount) {
    ...
    public SanchayTableModelBak(Vector data, Vector columnNames) {
        super(data, columnNames);
    ...
    public SanchayTableModelBak(String f, String charset) throws FileNotFoundException, IOException
    {
	super();
    ...
    public SanchayTableModelBak(String f, String charset, SanchayTableModelBak sch) throws FileNotFoundException, IOException
    {
        super();
    ...
    public SanchayTableModelBak(String f, String charset, String sf, String scharset) throws FileNotFoundException, IOException
    {
        super();

        schema = new SanchayTableModelBak();
    ...
    public SanchayTableModelBak(String charset, SanchayTableModelBak sch) throws FileNotFoundException, IOException
    {
        super();
        ...
        while (results.next())
        {
            ...
            { 
                ...
                if (columnClasses[i] == String.class) 
                    ...
                    System.out.println (GlobalProperties.getIntlString("Can't_assign_") + columnNames[i]);
...
//            return super.getColumnCount();
    ...
    public SanchayTableModelBak getSchema()
    {
        return schema;
    }
    
    public void setSchema(SanchayTableModelBak s)
    {
//        if(getColumnCount() == 0)
//        {
            schema = s;
...
//                object = cls.newInstance();
                ...
                Logger.getLogger(SanchayTableModelBak.class.getName()).log(Level.SEVERE, null, ex);
        ...
        while((line = lnReader.readLine()) != null)
        {
            if((!line.startsWith("#")) && line.equals("") == false)
            {
                ...
                if(line.startsWith(GlobalProperties.getIntlString("Schema::")))
                {
                    ...
                    setSchema(new SanchayTableModelBak(splitstr[1], splitstr[2]));
                }
...
//                    }
        ...
        while((line = lnReader.readLine()) != null)
        {
            if((!line.startsWith("#")) && line.equals("") == false)
            {
                ...
                else if(line.startsWith(GlobalProperties.getIntlString("Schema::")))
                {
                    ...
                    tbl.setSchema(new SanchayTableModelBak(splitstr[1], splitstr[2]));
                }
                else if(line.startsWith(GlobalProperties.getIntlString("Column_Names::")))
                {
                    splitstr = line.split("::");
    ...
    public static void printMany(LinkedHashMap tables, PrintStream ps)
    {
        ...
        for(int i = 0; i < count; i++)
        {
            ...
            SanchayTableModelBak tbl = (SanchayTableModelBak) tables.get(tblName);
    ...
    public Object clone() throws CloneNotSupportedException// copyFS($fs)
    {
        ...
        try {
            ...
            obj = (SanchayTableModelBak) is.readObject();
    ...
    public int copyRow(int row1, int colOffset1, SanchayTableModelBak toTable, int row2, int colOffset2)
    {
    ...
    public int copyColumn(int col1, int rowOffset1, SanchayTableModelBak toTable, int col2, int rowOffset2)
    {
    ...
    public static SanchayTableModelBak mergeRows(Vector tables, boolean addTableNumbers)
    {
	int maxColCount = 0;
	int rowCount = 0;
	...
	{
	    int ccount = ((SanchayTableModelBak) tables.get(i)).getColumnCount();
	    rowCount += ((SanchayTableModelBak) tables.get(i)).getRowCount();
	    
	    if(maxColCount < ccount)
		maxColCount = ccount;
	}
	
	SanchayTableModelBak mergedTable = new SanchayTableModelBak(rowCount, maxColCount + add);

    rowCount = 0;

	for (int i = 0; i < tables.size(); i++)
	{
	    SanchayTableModelBak tbl = ((SanchayTableModelBak) tables.get(i));
    ...
    public static SanchayTableModelBak mergeRows(Vector tables)
    {
	return mergeRows(tables, false);
    }
    
    public static SanchayTableModelBak mergeColumns(Vector tables)
    {
	int maxRowCount = 0;
	int colCount = 0;
	...
	for (int i = 0; i < tables.size(); i++)
	{
	    int rcount = ((SanchayTableModelBak) tables.get(i)).getRowCount();
	    colCount += ((SanchayTableModelBak) tables.get(i)).getColumnCount();
	    
	    if(maxRowCount < rcount)
		maxRowCount = rcount;
	}
	
	SanchayTableModelBak mergedTable = new SanchayTableModelBak(maxRowCount, colCount);
    ...
    public static void mapToTable(Map map, SanchayTableModelBak table, boolean reverse, boolean clear)
    {
    ...
    public static void mapToTable(Map map, SanchayTableModelBak table, boolean clear)
    {
