...
public class Evaluation2 {
    ...
    public Evaluation2(String referenceDataPath, String testDataPath, String resultsPath, String charset)
    {
    ...
    public EvaluationResults evaluatePOSTagging()
    {
        ...
        if(rscount != tscount)
        {
            System.err.println(GlobalProperties.getIntlString("Error:_Number_of_sentences_not_the_same."));
            return null;
        }
        ...
        for(int i = 0; i < rscount; i++)
        {
           ...
           // resultsPS.println("Evaluation mode: " + "POS Tagging");
            ...
            if(numDiff != null)
            {
                resultsPS.println(GlobalProperties.getIntlString("\tNumber_of_different_tags_in_sentence_") + (i + 1) + ": " + numDiff.length);
        ...
        System.out.println("Number of errors-"+totalDiffCount+" Precision-"+evaluationResults.getPrecision());
        resultsPS.println("**********************************************");
    ...
    public EvaluationResults evaluateChunking () throws Exception
    {
        ...
        System.out.println("Number of errors-"+errCount+" Precision"+evaluation.getPrecision());
        return evaluation;
    ...
    public EvaluationResults evaluateNestedChunking() throws Exception
    {
        return evaluateChunking();
    }
    ...
    {
       Evaluation2 ssfEvaluation = new Evaluation2("/media/disk/Users/53590/Desktop/IIIT H/CORPUS/shallow-parsing-test-data/240k-hindi-wx.ssf.clean-4-bform.isc.utf8",
                "/media/disk/Users/53590/Desktop/IIIT H/CORPUS/shallow-parsing-test-data/POS by CRF-240k-hindi-wx.ssf.clean-4-bform-raw.isc.utf8.out.txt.out.txt",
