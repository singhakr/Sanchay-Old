...
public class Evaluation1 {
    ...
    public Evaluation1(String referenceDataPath, String testDataPath, String resultsPath, String charset) {
    ...
    private void init() {
        ...
        try {
            ...
            Logger.getLogger(Evaluation1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) throws Exception {
        Evaluation1 ssfEvaluation = new Evaluation1("/media/disk/Users/53590/Desktop/IIIT H/Sanchay/Sanchay new version/Sanchay-17-05-09/data/automatic-annotation/chunking/testing/testing-1-utf8-ssf.txt.out_old.txt",
