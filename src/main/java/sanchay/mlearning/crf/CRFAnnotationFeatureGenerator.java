 ...
 */
public class CRFAnnotationFeatureGenerator extends FeatureGenImpl implements FeatureGeneratorNested {

    public CRFAnnotationFeatureGenerator(String modelSpecs, int numLabels) throws Exception {
        super(modelSpecs, numLabels, true);
    }

    public CRFAnnotationFeatureGenerator(String modelSpecs, int numLabels, boolean addFeatureNow) throws Exception {
        super(modelSpecs, numLabels, addFeatureNow);
    }

    public CRFAnnotationFeatureGenerator(Model m, int numLabels, boolean addFeatureNow) throws Exception {
