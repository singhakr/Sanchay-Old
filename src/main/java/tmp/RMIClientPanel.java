 ...
 */
public class RMIClientPanel extends javax.swing.JFrame {
    private final Registry registry;
    private final RMIFileSystemRI p;
    private File[] files;
     ...
     */
    public RMIClientPanel() throws RemoteException, NotBoundException {
        ...
        p = (RMIFileSystemRI)registry.lookup("myProtocol");
        
        // Reads the default directory
        files = p.listFiles(p.getDefaultDirectoryPathOnServer());
        currentDir = new File(p.getDefaultDirectoryPathOnServer());
    ...
    private boolean fileExists(String directory, String file) {
        ...
        // Reads the directory
        try {
            contents = p.listFiles(directory);
        } catch (RemoteException ex) {
            Logger.getLogger(RMIClientPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        String dirAbsPath = p.getAbsolutePathOnServer(directory);
        
//        System.out.println("Remote directory path: " + dirAbsPath);
        
//        try {
//            contents = p.listFiles(dirAbsPath);
//        } catch (RemoteException ex) {
//            Logger.getLogger(RMIClientPanel.class.getName()).log(Level.SEVERE, null, ex);
//        }
    ...
    private void openFolderButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_openFolderButtonMouseClicked
        ...
        try {
            ...
            files = p.listFiles(p.getAbsolutePathOnServer(""));
//            files = p.listFiles(p.getAbsolutePathOnServer(selectedItem));
    ...
    private void backButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backButtonMouseClicked
        ...
        if (!backButton.isEnabled()) return;
            ...
            try {
                ...
                files = p.listFiles(currentDir.getParentFile().getAbsolutePath());
    ...
    public static void main(String args[]) throws RemoteException, NotBoundException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RMIClientPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                    }
                    ...
                    new RMIClientPanel().setVisible(true);
